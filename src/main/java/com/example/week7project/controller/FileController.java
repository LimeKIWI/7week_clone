...
public class FileController {
    ...
    public ResponseDto<?> uploadImage(@RequestPart("image") List<MultipartFile> file, HttpServletRequest request) {
    ...
    public ResponseDto<?> updateImage(@PathVariable Long id, @RequestPart("image") List<MultipartFile> file, HttpServletRequest request) {
